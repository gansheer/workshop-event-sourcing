package com.zenika.ylegat.workshop.application;
...
import com.zenika.ylegat.workshop.domain.account.BankAccount;
import com.zenika.ylegat.workshop.domain.account.TransferProcessManager;
...
public class Server {
    ...
    public void run() {
        ...
        post("/account/:bankAccountId", (request, response) -> {
            ...
            handleError(() -> bankAccount.registerBankAccount(bankAccountId));
        ...
        get("/account/:bankAccountId/balance", ((request, response) -> {
            ...
            return totalCreditRepository.readCreditBalance(bankAccountId)
        ...
        post("/account/:bankAccountId/transfer/:credit/to/:bankAccountDestinationId",  ((request, response) -> {
            ...
            handleError(() -> bankAccount(bankAccountId).initializeTransfer(bankAccountDestinationId, creditOperation));
